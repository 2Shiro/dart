...
// 책 내용
// Mixin 을 사용하게 되면 다중 상속의 문제를 해결할 수 있고 컴퍼지션을 사용하지 않고
// 다른 클래스의 코드를 재사용할 수 있다.

// 집중!
// OOP 에서 객체 간의 관계를 정의하는 개념들
// 연관관계
...
// 1-2 집합관계
//     - 부분-전체 관계 중에서 전체와 부분의 생명주기가 독릭접인 관계를 말한다.
...
class Car {
  ...
  // Car(this.engin);
  // 생성자 코드 축약버전이다.(생성자 바디부분 생략)
  // Car(String engineType) : engine = Engine(enginType);
  // 생성자 코드이다.
